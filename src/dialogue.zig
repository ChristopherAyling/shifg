...
pub const PROLOGUE = DialogueSequence{
    ...
    .lines = &[_]DialogueLine{
        .{ .speaker_name = "Narrator:", .text = "i'll make my reports as if i told a\nstory," },
        .{ .speaker_name = "Narrator:", .text = "for i was taught as a child on my\nhomeworld that truth is a matter\nof imagination." },
        .{ .speaker_name = "Narrator:", .text = "the soundest of fact may fail or\nprevail in the style of its telling:" },
        .{ .speaker_name = "Narrator:", .text = "like that singular organic jewel\nof our seas," },
        .{ .speaker_name = "Narrator:", .text = "which grows brighter as one woman\nwears it and," },
        .{ .speaker_name = "Narrator:", .text = "worn by another, dulls and goes to\ndust." },
        .{ .speaker_name = "Narrator:", .text = "facts are no more solid, coherent,\nround, and real than pearls are." },
        .{ .speaker_name = "Narrator:", .text = "but both are sensitive." },
    },
